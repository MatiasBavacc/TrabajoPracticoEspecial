...
public class DTOReporte {
    ...
    public DTOReporte(Integer fechaEgreso, String nombreCarrera, Long cantInscriptos, Long cantGraduados){
        this.nombreCarrera = nombreCarrera;
        this.fechaEgreso = fechaEgreso;
        this.cantInscriptos = cantInscriptos;
        this.cantGraduados = cantGraduados;
    ...
    public DTOReporte(int fechaEgreso, String nombreCarrera, Long cantInscriptos, int cantGraduados) {
        this.fechaEgreso = fechaEgreso;
        this.nombreCarrera = nombreCarrera;
        this.cantInscriptos = cantInscriptos;
        this.cantGraduados = Integer.toUnsignedLong(cantGraduados);
    }
